...
func (o *ouvrier) traiteLeLot(ctx context.Context, lot *core.Record) error {
	...
	// l'ouvrier, il vivrait autant que le service, et un site qui se ferme entre
...
// recette.
func (o *ouvrier) traiteLaLigne(ctx context.Context, lot, ligne *core.Record,
	robots *recuperation.RobotsRetenus) error {
	...
	// La cadence est confiée à recuperation plutôt que tenue ici : un appel en
	// émet deux requêtes — le robots.txt de l'hôte, puis la page —, et les
	// espacer depuis ce niveau-ci laisserait toujours partir la paire dans le
	// même instant. C'est aussi elle qui rapporte le Crawl-delay lu, avant la
